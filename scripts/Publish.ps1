...
Public Windows executables require externally provisioned Azure Artifact Signing
through the canonical GitHub OIDC release workflow. Local unsigned packaging is
