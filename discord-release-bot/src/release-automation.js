...
const MESSAGE_FLAG_HAS_THREAD = 1 << 5;
const MESSAGE_FLAG_SUPPRESS_NOTIFICATIONS = 1 << 12;
const NORMAL_MESSAGE_FLAGS = [
  0,
  MESSAGE_FLAG_CROSSPOSTED,
  MESSAGE_FLAG_HAS_THREAD,
  MESSAGE_FLAG_CROSSPOSTED | MESSAGE_FLAG_HAS_THREAD,
  MESSAGE_FLAG_SUPPRESS_NOTIFICATIONS,
  MESSAGE_FLAG_CROSSPOSTED | MESSAGE_FLAG_SUPPRESS_NOTIFICATIONS,
  MESSAGE_FLAG_HAS_THREAD | MESSAGE_FLAG_SUPPRESS_NOTIFICATIONS,
  MESSAGE_FLAG_CROSSPOSTED | MESSAGE_FLAG_HAS_THREAD | MESSAGE_FLAG_SUPPRESS_NOTIFICATIONS,
];
const MIGRATION_SOURCE_MESSAGE_FLAGS = [
  MESSAGE_FLAG_CROSSPOSTED,
  MESSAGE_FLAG_SUPPRESS_EMBEDS,
  MESSAGE_FLAG_CROSSPOSTED | MESSAGE_FLAG_SUPPRESS_EMBEDS,
  MESSAGE_FLAG_HAS_THREAD,
  MESSAGE_FLAG_CROSSPOSTED | MESSAGE_FLAG_HAS_THREAD,
  MESSAGE_FLAG_SUPPRESS_EMBEDS | MESSAGE_FLAG_HAS_THREAD,
  MESSAGE_FLAG_CROSSPOSTED | MESSAGE_FLAG_SUPPRESS_EMBEDS | MESSAGE_FLAG_HAS_THREAD,
  MESSAGE_FLAG_SUPPRESS_NOTIFICATIONS,
  MESSAGE_FLAG_CROSSPOSTED | MESSAGE_FLAG_SUPPRESS_NOTIFICATIONS,
  MESSAGE_FLAG_SUPPRESS_EMBEDS | MESSAGE_FLAG_SUPPRESS_NOTIFICATIONS,
  MESSAGE_FLAG_CROSSPOSTED | MESSAGE_FLAG_SUPPRESS_EMBEDS | MESSAGE_FLAG_SUPPRESS_NOTIFICATIONS,
  MESSAGE_FLAG_HAS_THREAD | MESSAGE_FLAG_SUPPRESS_NOTIFICATIONS,
  MESSAGE_FLAG_CROSSPOSTED | MESSAGE_FLAG_HAS_THREAD | MESSAGE_FLAG_SUPPRESS_NOTIFICATIONS,
  MESSAGE_FLAG_SUPPRESS_EMBEDS | MESSAGE_FLAG_HAS_THREAD | MESSAGE_FLAG_SUPPRESS_NOTIFICATIONS,
  MESSAGE_FLAG_CROSSPOSTED |
    MESSAGE_FLAG_SUPPRESS_EMBEDS |
    MESSAGE_FLAG_HAS_THREAD |
    MESSAGE_FLAG_SUPPRESS_NOTIFICATIONS,
...
export async function migrateExistingAnnouncement({
  ...
  if (!MIGRATION_SOURCE_MESSAGE_FLAGS.includes(sourceFlags)) {
